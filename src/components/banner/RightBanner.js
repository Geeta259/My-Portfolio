             ...
             <div className='flex flex-col gap-3'>
                ...
                <div>
                    ...
                    <div className='flex gap-4'>
                       ...
                       <a href="images/Geeta_2col_Resume.pdf" download className='rounded-lg  w-30 h-10 ml-10 text-white text-xl p-2 cursor-pointer border-[1px] border-sky-400 hover:bg-sky-600 bg-opacity-60'>Download CV</a>
